...
internal class VerticalRecyclerViewHelper(
    ...
    override val scrollRange: Long
        get() = view.paddingTop + contentSize + view.paddingBottom
    ...
    override val scrollOffset: Long
        get() {
            ...
            return view.paddingTop + offset - firstItemOffset
        }
    ...
    override fun scrollTo(offset: Int) {
        ...
        // Find the position of the element that should be at the top
