...
import com.hieupt.android.standalonescrollbar.sample.databinding.ActivityVariousItemWidthHorizontalRecyclerViewBinding

class VariousItemWidthHorizontalRecyclerViewActivity :
    BaseBindingActivity<ActivityVariousItemWidthHorizontalRecyclerViewBinding>() {

    override val viewBindingInflater: (LayoutInflater) -> ActivityVariousItemWidthHorizontalRecyclerViewBinding
        get() = ActivityVariousItemWidthHorizontalRecyclerViewBinding::inflate

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        title = "Various Item Width Horizontal Recycler View"
        setupView {
